...
export default function Enroll() {
    ...
    const handleSubmission = (event) => {
        ...
        const candidates = form.candidates.checked;
        const offers = form.offers.checked;
        const pushNotifications = form['push-notifications'].value;
  ...
  return (
    <form onSubmit={handleSubmission} className='max-w-screen-xl mx-auto'>
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Profile</h2>
          <p className="mt-1 text-sm leading-6 text-gray-600">
            This information will be úsed for your admission purpose so be careful.
          </p>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                <FaUser aria-hidden="true" className="h-12 w-12 text-gray-300" />
                <button
                  type="button"
